@props(['align' => 'right', 'width' => '48', 'contentClasses' => 'py-1 glass rounded-lg bg-white/10 border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.25)] text-lg text-[#404ea6] dark:text-[#6962d1] overflow-hidden hover:text-gray-700 focus:outline-none transition ease-in-out duration-150'])
...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            style="display: none;"
            @click="open = false">
        <div class="dropdown rounded-md ring-1 ring-black ring-opacity-5 {{ $contentClasses }}">
